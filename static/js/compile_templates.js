...
output += runtime.suppressValue((lineno = 187, colno = 36, runtime.callWrap(t_6, "item_req_selector", context, ["medal_jetpac_behavior","medal_requirement","Medals for Jetpac",1,255,"Determines how Jetpac requirements are determined."])), env.opts.autoescape);
output += "\n                <!-- Pearls for Mermaid -->\n                ";
output += runtime.suppressValue((lineno = 189, colno = 36, runtime.callWrap(t_6, "item_req_selector", context, ["pearl_mermaid_behavior","mermaid_gb_pearls","Pearls for Mermaid",1,255,"Determines how Mermaid check requirements are determined."])), env.opts.autoescape);
output += "\n                <!-- Fairies for Queen -->\n                ";
output += runtime.suppressValue((lineno = 191, colno = 36, runtime.callWrap(t_6, "item_req_selector", context, ["fairy_queen_behavior","rareware_gb_fairies","Fairies for Fairy Queen",1,255,"Determines how Rareware GB check requirements are determined."])), env.opts.autoescape);
