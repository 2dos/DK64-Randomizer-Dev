...
output += "\n                    ";
output += runtime.suppressValue((lineno = 154, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["troff_brighten","Brighten Boss Door Opening",runtime.memberLookup(("Increased the lighting in Troff 'n' Scoff rooms to better see the item previewed in the opened Boss door."),"True")])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 155, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["better_dirt_patch_cosmetic","Higher contrast dirt patches",runtime.memberLookup(("Added red and yellow DK letters to dirt patches to better see them against the environment."),"True")])), env.opts.autoescape);
output += "\n                    ";
...
output += runtime.suppressValue((lineno = 233, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["camera_is_not_inverted","Disable Y-Inverted First Person Camera","If enabled, the camera will look up when the player holds up on the stick, the opposite of how the vanilla game behaves."])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 234, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["camera_is_follow","Follow Cam","Camera will always follow behind the player."])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 235, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["anamorphic_widescreen","Anamorphic Widescreen","The in-game anamorphic widescreen setting will be enabled by default."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 101, colno = 41, runtime.callWrap(t_9, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "excluded_songs"),"excluded_songs","Disabled Songs","This will open a dropdown that will let you customize what songs are disabled.",4])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 102, colno = 41, runtime.callWrap(t_9, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "song_filters"),"music_filtering","Music Filtering","This will open a dropdown that will let you customize how the game applies additional filters."])), env.opts.autoescape);
...
output += "\n                ";
output += runtime.suppressValue((lineno = 85, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["race_coin_rando","Random Race Coin Locations","Shuffle the locations of race coins to be placed inside levels instead of courses. You will have to pick up enough race coins in the levels in order to beat a race. Any minecart section will be auto-completed upon entering the course with enough coins. Other races will still require winning the race. Obtaining a race reward does not consume coins.",runtime.contextOrFrameLookup(context, frame, "False"),"Race Coins"])), env.opts.autoescape);
output += "\n                ";
...
output += runtime.suppressValue((lineno = 157, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["wrinkly_location_rando","Random Wrinkly Door Locations","Wrinkly Door Locations are randomized within levels and their respective lobbies.",runtime.contextOrFrameLookup(context, frame, "False"),"Wrinkly Doors"])), env.opts.autoescape);
output += "\n                ";
...
output += "\n                ";
output += runtime.suppressValue((lineno = 159, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["vanilla_door_rando","Vanilla Door Shuffle","Wrinkly Doors and T&S Portals are only shuffled among the vanilla locations for one another. T&S Portals cannot appear in level lobbies."])), env.opts.autoescape);
output += "\n                ";
...
output += runtime.suppressValue((lineno = 230, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["enemy_speed_rando","Random Enemy Speed","Enemy speeds are randomized."])), env.opts.autoescape);
output += "\n                ";
...
output += "\n                ";
output += "\n                <div class=\"spacer\"></div>\n            </div>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 339, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_mode"),"hard_mode","Hard Mode","This will open a dropdown that will let you customize what hard mode Options are active.",10])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 340, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_bosses"),"hard_bosses","Hard Bosses","This will open a dropdown that will let you customize what bosses are made harder.",10])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 165, colno = 27, runtime.callWrap(t_5, "slider_input", context, ["starting_kongs_count","Starting Kongs count",1,5])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 216, colno = 31, runtime.callWrap(t_5, "slider_input", context, ["helm_phase_count","Helm Length",1,5])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 452, colno = 35, runtime.callWrap(t_5, "slider_input", context, ["krool_phase_count","K. Rool Phase Count",1,5])), env.opts.autoescape);
