...
output += "\n                    ";
output += runtime.suppressValue((lineno = 111, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["dark_mode_textboxes","Dark Mode UI","Text bubbles will be darkened, with the font brightened. The DPad Graphic will be darkened."])), env.opts.autoescape);
output += "\n                    ";
...
output += "\n                    ";
output += runtime.suppressValue((lineno = 116, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["song_speed_near_win","Speed up song near Win Condition","Speeds up the music when you are 1 item away from your win condition. ONLY works for item count based win conditions."])), env.opts.autoescape);
output += "\n                    ";
...
output += runtime.suppressValue((lineno = 152, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["remove_water_oscillation","Remove Water Oscillation","Remove water oscillation effects and the seasick ship rocking effect. For those who feel motion sick from these effects."])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 153, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["head_balloons","Kong Head on Balloons","Adds kong faces to balloons, making them easier to distinguish in various lighting conditions.",runtime.contextOrFrameLookup(context, frame, "True")])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 154, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["troff_brighten","Brighten Boss Door Opening",runtime.memberLookup(("Brightens the door-opening sequence in Troff 'n' Scoff to make the reward easier to see."),"True")])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 155, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["better_dirt_patch_cosmetic","Higher contrast dirt patches",runtime.memberLookup(("Dirt Patches have the letters 'D' and 'K' colored yellow and red to make them more visible."),"True")])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 156, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["crosshair_outline","Outlined Crosshair","The crosshair used in various situations, like shooting your gun, will have a black outline."])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 157, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["fps_display","FPS Display","Displays an FPS counter tracked by the game itself."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 232, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["camera_is_not_inverted","Disable Y-Inverted First Person Camera","If enabled, the camera will look up when the player holds up on the stick, the opposite of how the vanilla game behaves."])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 233, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["camera_is_follow","Follow Cam","Camera will always follow behind the player."])), env.opts.autoescape);
output += "\n                    ";
output += runtime.suppressValue((lineno = 234, colno = 35, runtime.callWrap(t_5, "toggle_input", context, ["anamorphic_widescreen","Anamorphic Widescreen","The in-game anamorphic widescreen setting will be enabled by default."])), env.opts.autoescape);
...
frame = frame.push();
var t_11 = (lineno = 76, colno = 33, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "range"), "range", context, [5]));
...
output += runtime.suppressValue(t_12, env.opts.autoescape);
output += "\" style=\"min-height: 24px; margin-bottom: 10px;\"></div>\n                    ";
if(t_12 == 0) {
...
output += "\n                            ";
frame = frame.push();
var t_15 = runtime.contextOrFrameLookup(context, frame, "itemRando");
...
output += "\n                                ";
if(!runtime.memberLookup((t_16),"is_check")) {
output += "\n                                    ";
if(runtime.memberLookup((t_16),"is_dummy")) {
output += "\n                                        <li class=\"list-group-item show-if-ir-decouple\" value=\"";
output += runtime.suppressValue(runtime.memberLookup((t_16),"value"), env.opts.autoescape);
output += "\" tooltip=\"";
output += runtime.suppressValue(runtime.memberLookup((t_16),"tooltip"), env.opts.autoescape);
output += "\" check_count=\"";
output += runtime.suppressValue(runtime.memberLookup((t_16),"check_count"), env.opts.autoescape);
output += "\" items_count=\"";
output += runtime.suppressValue(runtime.memberLookup((t_16),"item_count"), env.opts.autoescape);
output += "\">";
...
output += "\n                    <ul id=\"item_rando_list_";
output += runtime.suppressValue(t_12 + 5, env.opts.autoescape);
output += "\" name=\"item_rando_list_";
output += runtime.suppressValue(t_12 + 5, env.opts.autoescape);
...
output += "\n                            ";
frame = frame.push();
var t_19 = runtime.contextOrFrameLookup(context, frame, "itemRando");
...
output += "\n                                ";
if(runtime.memberLookup((t_20),"is_check")) {
output += "\n                                    <li class=\"list-group-item ischeck\" value=\"";
output += runtime.suppressValue(runtime.memberLookup((t_20),"value"), env.opts.autoescape);
output += "\" tooltip=\"";
output += runtime.suppressValue(runtime.memberLookup((t_20),"tooltip"), env.opts.autoescape);
output += "\" check_count=\"";
output += runtime.suppressValue(runtime.memberLookup((t_20),"check_count"), env.opts.autoescape);
output += "\" items_count=\"";
output += runtime.suppressValue(runtime.memberLookup((t_20),"item_count"), env.opts.autoescape);
output += "\" tied_item=\"";
output += runtime.suppressValue(runtime.memberLookup((t_20),"tied"), env.opts.autoescape);
output += "\">";
...
frame = frame.push();
var t_23 = runtime.contextOrFrameLookup(context, frame, "custom_starting_moves");
if(t_23) {t_23 = runtime.fromIterator(t_23);
var t_22 = t_23.length;
for(var t_21=0; t_21 < t_23.length; t_21++) {
var t_24 = t_23[t_21];
...
output += runtime.suppressValue((lineno = 101, colno = 41, runtime.callWrap(t_9, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "excluded_songs"),"excluded_songs","Disabled Songs","This will open a popup that will let you customize what songs are disabled.",4])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 102, colno = 41, runtime.callWrap(t_9, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "song_filters"),"music_filtering","Music Filtering","This will open a popup that will let you customize how the game applies additional filters.",2,1,"These filters only work for .candy files."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 126, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["fill_with_custom_music","Fill game with provided songs","Will fill each song slot available with a custom track, even if the amount of songs in that pack doesn't exceed the amount of song slots."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 127, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["show_song_name","Display song name in-game","Will display the song name for 2 seconds upon it playing (Only applies to BGM)."])), env.opts.autoescape);
...
output += "\n    ";
output += runtime.suppressValue((lineno = 11, colno = 14, runtime.callWrap(t_4, "gen_tab", context, ["settings","fa-circle-info","Settings",false,true])), env.opts.autoescape);
output += "\n    ";
output += "\n</ul>";
if(parentTemplate) {
parentTemplate.rootRenderFunc(env, context, frame, runtime, cb);
...
output += runtime.suppressValue((lineno = 83, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["random_patches","Random Dirt Patch Locations","Dirt Patches for Rainbow Coins are in random locations.",runtime.contextOrFrameLookup(context, frame, "False"),"Dirt Patches"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 84, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["coin_rando","Random Banana Coin Locations","Shuffle the locations of coins within each Level.",runtime.contextOrFrameLookup(context, frame, "False"),"Banana Coins"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 85, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["race_coin_rando","Random Race Coin Locations","Shuffle the locations of race coins to be placed inside levels instead of courses.",runtime.contextOrFrameLookup(context, frame, "False"),"Race Coins"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 86, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["random_fairies","Random Banana Fairy Locations","Fairy checks are in random locations.",runtime.contextOrFrameLookup(context, frame, "False"),"Banana Fairies"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 87, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["crown_placement_rando","Random Battle Crown Pad Locations","Crown Locations are randomized. There's 1 in each level, except Isles which has two.",runtime.contextOrFrameLookup(context, frame, "False"),"Battle Crowns"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 88, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["random_crates","Random Melon Crate Locations","Melon Crate Locations are randomized.",runtime.contextOrFrameLookup(context, frame, "False"),"Melon Crates"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 89, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["randomize_pickups","Randomize Pickups","All Replenishables in the game are randomized.&#10;*Homing Ammo, Regular Ammo, Oranges, Film, Crystals"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 90, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["shuffle_shops","Shuffle Shop Locations","Shuffle the locations of shops (including Snides) within each Level/Isles."])), env.opts.autoescape);
output += "\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"Colored Banana Locations are randomized.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"cb_rando_enabled\"\n                                id=\"cb_rando_enabled\"\n                                display_name=\"Randomize CB Locations\"\n                                value=\"True\"/>\n                        Colored Bananas\n                    </label>\n                    ";
output += runtime.suppressValue((lineno = 102, colno = 36, runtime.callWrap(t_5, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "cb_rando_levels"),"cb_rando_list","LEVELS","This will open a popup that will let you customize what levels have CB rando in the game.&#10;This defaults to All options.",8,1])), env.opts.autoescape);
output += "\n                ";
...
output += runtime.suppressValue((lineno = 151, colno = 44, runtime.callWrap(t_5, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "vanilla_warps"),"warp_level_list","LEVEL SELECTOR","This will open a popup that will let you customize what levels' warps are in the pool. Any level not selected will have its vanilla warp locations.&#10;This defaults to All levels.",10,1])), env.opts.autoescape);
output += "\n                        ";
output += "\n                    </div>\n                </div>\n            </div>\n            <div class=\"flex-container\" style=\"margin-top: 20px;\">\n                ";
output += runtime.suppressValue((lineno = 157, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["wrinkly_location_rando","Random Wrinkly Door Locations","Wrinkly Door Locations are randomized.",runtime.contextOrFrameLookup(context, frame, "False"),"Wrinkly Doors"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 158, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["tns_location_rando","Random Troff 'n' Scoff Portal Locations","T&S Portal Locations are randomized.",runtime.contextOrFrameLookup(context, frame, "False"),"Troff 'n' Scoff Portals"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 159, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["vanilla_door_rando","Vanilla Door Shuffle","Wrinkly Doors and T&S Portals are shuffled among the vanilla locations."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 160, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["dos_door_rando","Dos' Doors","Vanilla Door Shuffle with some restrictions:&#10;- One T&S per level&#10;- One hint door in each lobby&#10;- DK Portal Rando enabled"])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 185, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["boss_location_rando","Shuffle Boss Location","The boss you can get in a level is different than normal."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 203, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "enemies"),"enemies","Shuffled Enemies","This will open a popup that will let you customize what enemies appear in the game.&#10;This defaults to All options.",16,1])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 230, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["enemy_speed_rando","Shuffle Enemy Speed","Enemy speeds are randomized."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 231, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["randomize_enemy_sizes","Random Enemy Size","The size of enemies is randomized."])), env.opts.autoescape);
output += "\n            </div>\n            <hr />\n            <h2 class=\"title\">BONUS BARRELS</h2>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 236, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "minigames"),"minigames_list","Shuffled Bonus Barrels","This will open a popup that will let you customize what Bonus Games are in the pool.&#10;This defaults to All minigames.",18,1])), env.opts.autoescape);
output += "\n                <div class=\"spacer\"></div>\n                ";
output += runtime.suppressValue((lineno = 238, colno = 31, runtime.callWrap(t_4, "toggle_input", context, ["disable_hard_minigames","Disable Hard Minigames","Disables harder minigames."])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 334, colno = 42, runtime.callWrap(t_6, "properties_selector", context, [runtime.contextOrFrameLookup(context, frame, "helm_hurry_items"),"helmhurry_list","HELM HURRY SELECTOR","This will open a popup that will let you customize what how much time each item will give you."])), env.opts.autoescape);
output += "\n                ";
output += "\n                <div class=\"spacer\"></div>\n            </div>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 339, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_mode"),"hard_mode","Hard Mode","This will open a popup that will let you customize what hard mode Options are active.",10])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 340, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_bosses"),"hard_bosses","Hard Bosses","This will open a popup that will let you customize what bosses are made harder.",10])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 109, colno = 31, runtime.callWrap(t_5, "slider_input", context, ["krool_key_count","Keys required to Beat K. Rool",0,8])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 122, colno = 32, runtime.callWrap(t_4, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "keys"),"starting_keys_list","STARTING KEYS SELECTOR","This will open a popup that will let you customize what Keys you start with.&#10;This defaults to starting with no keys if none are selected.",8])), env.opts.autoescape);
output += "\n            ";
...
output += runtime.suppressValue((lineno = 164, colno = 27, runtime.callWrap(t_5, "slider_input", context, ["starting_kongs_count","Starting Kongs count",1,5])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 215, colno = 31, runtime.callWrap(t_5, "slider_input", context, ["helm_phase_count","Helm Length",1,5])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 451, colno = 35, runtime.callWrap(t_5, "slider_input", context, ["krool_phase_count","K. Rool Phase Count",1,5])), env.opts.autoescape);
...
output += "\n";
env.getTemplate("dropdown_multiselector.html", false, "qualityoflife.html", false, function(t_7,t_6) {
if(t_7) { cb(t_7); return; }
t_6.getExported(function(t_8,t_6) {
if(t_8) { cb(t_8); return; }
if(Object.prototype.hasOwnProperty.call(t_6, "dropdown_multiselector")) {
...
output += runtime.suppressValue((lineno = 7, colno = 41, runtime.callWrap(t_9, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "misc_changes"),"misc_changes","Misc Changes","This will open a popup that will let you customize what Quality of Life Options are active.&#10;This defaults to All options.",18,1])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 320, colno = 42, runtime.callWrap(t_5, "properties_selector", context, [runtime.contextOrFrameLookup(context, frame, "points_spread"),"points_list","POINTS SPREAD","This will open a popup that will let you customize your points spread."])), env.opts.autoescape);
output += "\n                    ";
...
frame = frame.pop();
output += "\n                                </div>\n                            </div>\n                            <div class=\"modal-footer\">\n                                <button type=\"button\" class=\"btn btn-danger\" data-bs-dismiss=\"modal\">Close</button>\n                            </div>\n                        </div>\n                    </div>\n                </div>\n            </div>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 180, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["maximize_helm_blocker","Maximize Helm B. Locker","Check box to ensure Helm is 'Max Value'."])), env.opts.autoescape);
output += "\n                <div class=\"spacer\"></div>\n            </div>\n            <hr />\n            <h2 class=\"title\">ITEM REQUIREMENTS</h2>\n            <div class=\"flex-container\">\n                <!-- Medals for Jetpac-->\n                ";
output += runtime.suppressValue((lineno = 187, colno = 36, runtime.callWrap(t_6, "item_req_selector", context, ["medal_jetpac_behavior","medal_requirement","Medals for Jetpac",1,40,"Determines how Jetpac requirements are determined."])), env.opts.autoescape);
output += "\n                <!-- Pearls for Mermaid -->\n                ";
output += runtime.suppressValue((lineno = 189, colno = 36, runtime.callWrap(t_6, "item_req_selector", context, ["pearl_mermaid_behavior","mermaid_gb_pearls","Pearls for Mermaid",1,5,"Determines how Mermaid check requirements are determined."])), env.opts.autoescape);
output += "\n                <!-- Fairies for Queen -->\n                ";
...
output += runtime.suppressValue((lineno = 225, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["shops_dont_cost","Tooie-Style Shops","Shops will not deduct coins from the player, but will require a certain amount of coins to purchase the move, akin to Banjo-Tooie."])), env.opts.autoescape);
output += "\n                <div class=\"spacer\"></div>\n            </div>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 229, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "remove_barriers"),"remove_barriers","Remove Barriers","This will open a popup that will let you customize what barriers are removed.&#10;This defaults to All options.",12,1])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 332, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "faster_checks"),"faster_checks","Faster Checks","This will open a popup that will let you customize what checks are sped up.&#10;This defaults to All options.",12,1])), env.opts.autoescape);
