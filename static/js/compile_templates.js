...
output += "\n                ";
output += "\n                <div class=\"spacer\"></div>\n            </div>\n            <div class=\"flex-container\">\n                ";
output += runtime.suppressValue((lineno = 357, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_mode"),"hard_mode","Hard Mode","This will open a dropdown that will let you customize what hard mode Options are active.",10])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 358, colno = 41, runtime.callWrap(t_10, "dropdown_multiselector", context, [runtime.contextOrFrameLookup(context, frame, "hard_bosses"),"hard_bosses","Hard Bosses","This will open a dropdown that will let you customize what bosses are made harder.",10])), env.opts.autoescape);
