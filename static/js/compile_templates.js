...
output += runtime.suppressValue((lineno = 115, colno = 31, runtime.callWrap(t_5, "slider_input", context, ["krool_key_count","Keys required to Beat K. Rool",0,8])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 128, colno = 32, runtime.callWrap(t_4, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "keys"),"starting_keys_list","STARTING KEYS SELECTOR","This will open a popup that will let you customize what Keys you start with.&#10;This defaults to starting with no keys if none are selected.",8])), env.opts.autoescape);
output += "\n            ";
...
output += runtime.suppressValue((lineno = 171, colno = 27, runtime.callWrap(t_5, "slider_input", context, ["starting_kongs_count","Starting Kongs count",1,5])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 222, colno = 31, runtime.callWrap(t_5, "slider_input", context, ["helm_phase_count","Helm Length",1,5])), env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 458, colno = 35, runtime.callWrap(t_5, "slider_input", context, ["krool_phase_count","K. Rool Phase Count",1,5])), env.opts.autoescape);
