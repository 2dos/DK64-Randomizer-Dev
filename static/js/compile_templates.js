...
frame = frame.push();
var t_23 = (lineno = 329, colno = 33, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "range"), "range", context, [0,5]));
if(t_23) {t_23 = runtime.fromIterator(t_23);
var t_22 = t_23.length;
for(var t_21=0; t_21 < t_23.length; t_21++) {
var t_24 = t_23[t_21];
...
output += runtime.suppressValue(t_24 + 1, env.opts.autoescape);
...
output += runtime.suppressValue((lineno = 17, colno = 36, runtime.callWrap(t_4, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "misc_changes"),"misc_changes","MISC CHANGES","This will open a popup that will let you customize what Quality of Life Options are active.&#10;This defaults to All options.",18,1])), env.opts.autoescape);
output += "\n                    ";
...
output += runtime.suppressValue((lineno = 336, colno = 42, runtime.callWrap(t_5, "properties_selector", context, [runtime.contextOrFrameLookup(context, frame, "points_spread"),"points_list","POINTS SPREAD","This will open a popup that will let you customize your points spread."])), env.opts.autoescape);
output += "\n                    ";
...
output += "\n                ";
output += runtime.suppressValue((lineno = 103, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["wrinkly_location_rando","Random Wrinkly Door Locations","Wrinkly Door Locations are randomized.",runtime.contextOrFrameLookup(context, frame, "False"),"Wrinkly Doors"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 104, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["tns_location_rando","Random Troff 'n' Scoff Portal Locations","T&S Portal Locations are randomized.",runtime.contextOrFrameLookup(context, frame, "False"),"Troff 'n' Scoff Portals"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 105, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["vanilla_door_rando","Vanilla Door Shuffle","Wrinkly Doors and T&S Portals are shuffled among the vanilla locations."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 106, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["crown_placement_rando","Random Battle Crown Pad Locations","Crown Locations are randomized. There's 1 in each level, except Isles which has two.",runtime.contextOrFrameLookup(context, frame, "False"),"Battle Crowns"])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 107, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["random_crates","Random Melon Crate Locations","Melon Crate Locations are randomized.",runtime.contextOrFrameLookup(context, frame, "False"),"Melon Crates"])), env.opts.autoescape);
output += "\n                <div class=\"spacer\"></div>\n            </div>\n            <div class=\"flex-container\">\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"Colored Banana Locations are randomized.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"cb_rando_enabled\"\n                                id=\"cb_rando_enabled\"\n                                display_name=\"Randomize CB Locations\"\n                                value=\"True\"/>\n                        Colored Bananas\n                    </label>\n                    ";
output += runtime.suppressValue((lineno = 122, colno = 36, runtime.callWrap(t_4, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "cb_rando_levels"),"cb_rando_list","LEVELS","This will open a popup that will let you customize what levels have CB rando in the game.&#10;This defaults to All options.",8,1])), env.opts.autoescape);
output += "\n                ";
...
output += runtime.suppressValue((lineno = 189, colno = 44, runtime.callWrap(t_4, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "vanilla_warps"),"warp_level_list","LEVEL SELECTOR","This will open a popup that will let you customize what levels' warps are in the pool. Any level not selected will have its vanilla warp locations.&#10;This defaults to All levels.",10,1])), env.opts.autoescape);
output += "\n                        ";
output += "\n                    </div>\n                </div>\n            </div>\n        </div>\n            <div class=\"col border panel\">\n                <h2 class=\"title\">GLOBAL</h2>\n            <div class=\"flex-container\">\n                <div class=\"form-check form-switch item-switch\">\n                    <label data-toggle=\"tooltip\"\n                            title=\"All normal enemies that spawn in the world are randomized.\">\n                        <input class=\"form-check-input\"\n                                type=\"checkbox\"\n                                name=\"enemy_rando\"\n                                id=\"enemy_rando\"\n                                display_name=\"Shuffle Enemies\"\n                                value=\"True\"/>\n                        Shuffle Enemies\n                    </label>\n                    ";
output += runtime.suppressValue((lineno = 209, colno = 36, runtime.callWrap(t_4, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "enemies"),"enemies","ENEMIES","This will open a popup that will let you customize what enemies appear in the game.&#10;This defaults to All options.",16,1])), env.opts.autoescape);
output += "\n                ";
...
output += runtime.suppressValue((lineno = 222, colno = 36, runtime.callWrap(t_4, "list_selector", context, [runtime.contextOrFrameLookup(context, frame, "minigames"),"minigames_list","MINIGAME SELECTOR","This will open a popup that will let you customize what Bonus Games are in the pool.&#10;This defaults to All minigames.",18,1])), env.opts.autoescape);
output += "\n                ";
output += "\n                ";
output += runtime.suppressValue((lineno = 224, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["enemy_speed_rando","Shuffle Enemy Speed","Enemy speeds are randomized."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 225, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["randomize_enemy_sizes","Random Enemy Size","The size of enemies is randomized."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 226, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["boss_location_rando","Shuffle Boss Location","The boss you can get in a level is different than normal."])), env.opts.autoescape);
output += "\n                ";
output += runtime.suppressValue((lineno = 227, colno = 31, runtime.callWrap(t_5, "toggle_input", context, ["kong_rando","Shuffle Kongs","Starting kong and kong locations have been randomized."])), env.opts.autoescape);
